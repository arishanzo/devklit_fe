                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 mb-8">
                    ...
                    <div>
                        ...
                        <ul className="space-y-2">
                            <li><Link href="#" className="text-gray-300 hover:text-white transition-colors">Cloud Services</Link></li>
                            <li><Link href="#" className="text-gray-300 hover:text-white transition-colors">AI & Machine Learning</Link></li>
                            <li><Link href="#" className="text-gray-300 hover:text-white transition-colors">Cybersecurity</Link></li>
                            <li><Link href="#" className="text-gray-300 hover:text-white transition-colors">Data Analytics</Link></li>
                        </ul>
                    </div>
                    ...
                    <div>
                        ...
                        <ul className="space-y-2">
                            ...
                            <li><Link href="#" className="text-gray-300 hover:text-white transition-colors">API Status</Link></li>
                        </ul>
                    </div>
                </div>
                ...
                <div className="border-t border-white/10 pt-8 mb-8">
                    <div className="max-w-md">
                        ...
                        <div className="flex gap-2">
                            ...
                            />
                            <button className="px-6 py-2 bg-gradient-to-r from-blue-500 to-purple-500 rounded-lg font-medium hover:shadow-lg hover:scale-105 transition-all">
                                Subscribe
                            </button>
                        </div>
                    </div>
